...
try {
	...
	await execFileAsync(
		...
		[
			"--input-type=module",
			"--eval",
			'const workflow = await import("@vegardx/pi-workflow"); const extension = await import("@vegardx/pi-workflow/extension"); const subagent = await import("@vegardx/pi-subagent"); const provider = await import("@vegardx/pi-subagent/service-provider"); const manifest = JSON.parse(await (await import("node:fs/promises")).readFile("node_modules/@vegardx/pi-workflow/package.json", "utf8")); if (workflow.WORKFLOW_RUNTIME_CONTRACT.schema !== "pi-workflow-runtime" || !workflow.isCompatibleSubagentContract(subagent.SUBAGENT_RUNTIME_CONTRACT) || typeof provider.acquireSubagentService !== "function" || typeof workflow.WorkflowRunJournal?.open !== "function" || typeof workflow.acquireWorkflowRunLease !== "function" || typeof workflow.createWorkflowSubagentProvider !== "function" || typeof workflow.createWorkflowTaskLauncher !== "function" || typeof workflow.createWorkflowSequentialScheduler !== "function" || typeof workflow.WorkflowArtifactStore?.open !== "function" || typeof workflow.createWorkflowTaskFinalizer !== "function" || typeof workflow.createStaticWorkflowRuntime !== "function" || typeof workflow.createWorkflowService !== "function" || workflow.DEFAULT_MAX_WORKFLOW_COST !== 1000 || !workflow.WorkflowBudgetSchema || typeof workflow.defineSupportTask !== "function" || typeof workflow.createWorkflowSupportTaskExecutor !== "function" || typeof workflow.supportRegistrationIdentity !== "function" || typeof workflow.deriveSupportImplementationIdentitySha256 !== "function" || !workflow.SupportTaskExecutionRecordSchema || !workflow.SupportTaskTerminalEvidenceSchema || typeof workflow.createWorkflowNestedRunExecutor !== "function" || typeof workflow.deriveNestedWorkflowRunId !== "function" || !workflow.NestedWorkflowTaskSpecSchema || !workflow.NestedWorkflowTerminalEvidenceSchema || !workflow.NestedWorkflowInputArtifactsSchema || workflow.WORKFLOW_CONTRACT_REVISION !== 15 || workflow.MAX_NESTED_WORKFLOW_DEPTH !== 4 || workflow.MAX_TASK_EXECUTION_GENERATIONS !== 16 || workflow.WORKFLOW_RUNTIME_CONTRACT.features.supportTaskExecution !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.nestedWorkflows !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.nestedArtifactInputs !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.retryAttempts !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.resumeAttempts !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.executionGenerations !== true || workflow.WORKFLOW_RUNTIME_CONTRACT.features.transactionalInvalidation !== true || typeof workflow.invalidationClosure !== "function" || typeof workflow.createWorkflowTaskRetrier !== "function" || !workflow.AgentRetryPolicySchema || typeof extension.default !== "function" || manifest.pi?.extensions?.[0] !== "./dist/extension.js") throw new Error("packed exports are unavailable or incompatible");',
		],
		{ cwd: project, encoding: "utf8", maxBuffer: 8 * 1024 * 1024 },
	);
} finally {
