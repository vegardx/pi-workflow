...
6 rejects revision-1 through revision-5 leases, journals, snapshots, and run
records; no migration or dual-format reader is provided. Revision 6 accepts only the
...
invalidation. Revision 6 currently admits generation 1 only; later generations
