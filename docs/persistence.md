...
7 rejects revision-1 through revision-6 leases, journals, snapshots, and run
records; no migration or dual-format reader is provided. Revision 7 accepts only the
...
invalidation. Revision 7 currently admits generation 1 only; later generations
